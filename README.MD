...
Mi PC de casa se reinició debido a las actualizaciones de Windows y se perdieron 3 días de trabajo de procesamientod de datos para obtener la data de aafit,bbfit, muon y otras.
